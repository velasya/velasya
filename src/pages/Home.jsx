  ...
  const liveAuctions = [
    {
      ...
      image:
        "https://images.pexels.com/photos/821738/pexels-photo-821738.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      currentBid: 1250,
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/3645420/pexels-photo-3645420.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      currentBid: 890,
  ...
  const upcomingAuctions = [
    {
      ...
      title: "Sunset Bliss",
      image:
        "https://images.pexels.com/photos/1237119/pexels-photo-1237119.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      auctionDate: "Nov 12",
    },
    {
      id: 2,
      title: "Ancient Grace",
      image:
        "https://images.pexels.com/photos/134402/pexels-photo-134402.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      auctionDate: "Nov 15",
    },
    {
      id: 3,
      ...
      image:
        "https://images.pexels.com/photos/9428799/pexels-photo-9428799.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      auctionDate: "Nov 18",
    },
    {
      id: 4,
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
              Discover Rare <span className="text-vintage-gold">Treasures</span>{" "}
              & Bid to Win
            </h1>

            <p className="text-xl text-vintage-cream/80 max-w-xl">
              Join the most exclusive auction marketplace for collectors and
              enthusiasts. Every piece tells a story.
            </p>
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md rounded-lg p-4 border border-white/20">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-vintage-gold text-lg font-bold">
                      $4,250.00
                    </p>
                  </div>
      ...
      <div className="bg-vintage-navy py-16 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-4xl font-bold text-vintage-cream">
              Live Auctions
            </h2>
            <Link
              to="/auth"
              className="flex items-center text-vintage-gold hover:text-vintage-cream transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {liveAuctions.map((auction) => (
              <Link key={auction.id} className="relative group">
                ...
                <div className="relative bg-white/10 backdrop-blur-md rounded-lg overflow-hidden border border-white/20">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-vintage-cream/70 mb-4">
                      {auction.category}
                    </p>
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="bg-vintage-gold hover:bg-vintage-gold/90 text-vintage-navy px-4 py-2 rounded-full font-medium transition-all duration-300 transform group-hover:-translate-y-1">
                        Place Bid
                      </button>
                    </div>
                  </div>
      ...
      <div className="bg-vintage-navy/95 py-16 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-vintage-cream text-center mb-12">
            Upcoming Auctions
          </h2>
      ...
      <footer className="bg-vintage-navy border-t border-white/10 py-12 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-vintage-cream/80">
                Your trusted destination for unique collectibles and vintage
                treasures.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/about"
                    className="text-vintage-cream/80 hover:text-vintage-gold">
                    About Us
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-vintage-cream/20 mt-8 pt-8 text-center text-vintage-cream/60">
            <p>
              &copy; {new Date().getFullYear()} Velasya. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
